...
<body style="background-color: rgb(73, 72, 72);">
  ...
  <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
    ...
    <section class="bg-color-rgb(15,22,30) from-black-900 to-black-900 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800">
        <div class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
            <img class="w-full dark:hidden" src="wallpaperflare-cropped.jpg" alt="dashboard image">
            <img class="w-full hidden dark:block" src="wallpaperflare-cropped.jpg" alt="dashboard image">
